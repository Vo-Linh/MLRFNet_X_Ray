...
class Res2Net(nn.Module):
    ...
    Args:
        block (Bottle2neck): The building block for the Res2Net.
    ...
    def __init__(self, block, layers, baseWidth=26, scale=4, num_classes=1000):
        ...
        # TODO
        # 1. Make config file remove magic number 
...
if __name__ == "__main__":
    ...
    res2net = res2net101_26w_4s(pretrained=False)
    for i in range(3):
        print(res2net(x)[i].shape)
